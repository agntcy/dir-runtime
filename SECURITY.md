...
The Directory Runtime project team welcomes security reports and is committed to
...
users of Directory Runtime, and maintainers of upstream dependencies if applicable.

Downstream project maintainers and Directory Runtime users can request participation in
...
Participation in security issue coordination processes is at the discretion of the Directory Runtime team.

## Security advisories

The project team is committed to transparency in the security issue disclosure
process. The Directory Runtime team announces security issues via [project GitHub Release notes](https://github.com/agntcy/dir-runtime/releases).
